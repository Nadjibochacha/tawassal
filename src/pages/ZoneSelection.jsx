  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-10 max-w-6xl mx-auto">
        <button onClick={onBack} className="text-xl font-bold text-blue-500 bg-white px-6 py-2 rounded-full shadow-sm">
          ← العودة
        </button>
        ...
        {currentZones.map((zone) => {
          ...
          return (
            <button
              ...
              className={`group relative p-8 rounded-[40px] shadow-xl border-b-8 transition-all
